      ...
      {loading == true ? (
        ...
        >
          ...
          <Item
            ...
            name="ct_keywords"
            label="Ct Keywords"
            rules={[{ required: true, message: "Please insert ct keywords!" }]}
          >
            <JoditEditor
              useID={true}
          ...
          <Item
            name="comments"
            label="Comments"
            initialValue={editedValue?.comments}
          >
            <JoditEditor
          ...
          <Item
            initialValue={editedValue?.graphics}
            name="graphics"
            label="Graphic and Other Files"
          >
            <JoditEditor
                                ...
                                rules={[
                                  ...
                                  },
                                  {
                                    validator(rule, value, callback) {
                                      ...
                                      if (duplicateIdx != null) {
                                        return Promise.reject("Already Chosen");
                                      } else {
                                        return Promise.resolve();
                                      }
                                    },
